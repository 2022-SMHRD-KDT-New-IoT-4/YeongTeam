...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <p style="text-align: justify;">우리의 미션은 반려묘의 건강상태를 지속적으로 관찰하고 예측함으로써 이상이 생기면 즉각적인 대처가 가능하게 만들어주는 일입니다. </p>
      <p style="text-align: justify;">고양이가 화장실을 이용할 시 무게를 측정하여 몸무게를 웹상으로 전송해 지속적인 무게 변화를 관찰할 수 있습니다. </p>
      <p style="text-align: justify;">또한 화장실 이용 후 일정시간이 지나면 설치해 둔 팬이 돌아가며 공기청정 효과를 줄 수 있습니다.</p>
      <p style="text-align: justify;">이용한 시간과 횟수, 배변 종류 등을 기록해 연동된 Cat Days 웹에서 확인할 수 있습니다. </p><br>
    </div>
  </div>
</div>
