			...
			<form action="Login.do" method="post">
				...
				<br>
					...
					<span class="box int_id"><input type="text" id="id"
						name="id" class="int check" maxlength="20"
						placeholder="아이디를 입력하세요"></span>
				</div>
				<!-- 비밀번호 입력 -->
				<div class="userInput">
					<h3 class="list">비밀번호</h3>
					<span class="box int_id"><input type="password" id="pw"
						name="pw" class="int check" maxlength="20"
						placeholder="비밀번호를 입력하세요"></span>
					<!--  <div class="col-12" style="margin-top: 2%;" align="center">  -->
					<span> <input type="submit" value="로그인" class="button fit"
						style="border: none; color: white; background-color: rgb(189, 120, 212);">
						<br> 
						<br> 
						<br>
					</span>
