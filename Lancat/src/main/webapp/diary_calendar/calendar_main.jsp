...
<div class="monthly" id="mycalendar"></div>
	...
	<br>
		...
		<div style="width: 500px; height: 50px; border: 2px solid black; text-align: center; margin-left: 900px;">작성한 육묘일기 보러가기
			<!-- 대강 넘어가는 것만 모려고 만든 폼태그 이동 확인 완 -->
			<form action="Diary_Select.do">
				<input type="submit" value="이동" style="margin-top: 10%;">
			</form>
